...
<body>
    ...
    <div class="container">
        ...
        <div class="card shadow">
            <div class="card-body">
                <form method="POST" action="/project1/Product/edit/<?php echo $product->getID(); ?>" class="needs-validation" novalidate>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control" id="price" name="price" 
                                   value="<?php echo htmlspecialchars($product->getPrice(), ENT_QUOTES, 'UTF-8'); ?>" step="0.01" required>
